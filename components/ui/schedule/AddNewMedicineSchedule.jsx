...
const AddNewMedicineSchedule = ({ visible, onClose, onAdd }) => {
  ...
  useEffect(() => {
    if (showTimePicker) {
      const hours = newMedicine.time.getHours();
      const minutes = newMedicine.time.getMinutes();
  ...
  }, [showTimePicker, newMedicine.time]);
  ...
  const handleStartDateChange = () => {
    ...
    const updatedMedicine = { ...newMedicine, startDate: selectedDate };
    
    // If end date is set and is before the new start date, clear it
    if (newMedicine.endDate && selectedDate > newMedicine.endDate) {
  ...
  const handleEndDateChange = () => {
    ...
    setNewMedicine({ ...newMedicine, endDate: selectedDate });
  ...
  const handleAddMedicine = () => {
    ...
    if (newMedicine.endDate && newMedicine.endDate <= newMedicine.startDate) {
  ...
  const resetForm = () => {
    ...
    setSelectedStartMonth(today.getMonth());
  ...
  const calculateDuration = () => {
    if (!newMedicine.endDate) return '';
    const diffTime = Math.abs(newMedicine.endDate - newMedicine.startDate);
            ...
            <View style={styles.modalContainer}>
              ...
              >
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <Text style={styles.dateText}>{formatDate(newMedicine.startDate)}</Text>
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <Text style={[styles.dateText, !newMedicine.endDate && styles.placeholderText]}>
                      {newMedicine.endDate ? formatDate(newMedicine.endDate) : 'No end date'}
                    </Text>
                    <View style={styles.dateInputActions}>
                      {newMedicine.endDate && (
                        <TouchableOpacity 
                          onPress={() => setNewMedicine({...newMedicine, endDate: null})}
